...
const EMPRESAS = [
  ...
  },
  {
    ...
    descripcion:
      'Correduría que trabaja como gerente externo de riesgos: audita el programa asegurador, prepara técnicamente el riesgo, negocia con el mercado y defiende la posición del asegurado cuando hay siniestro.',
    servicios: [
      'Empresas: gerencia de riesgos y auditoría del programa',
      'Transporte, flotas, industria y agroalimentario',
