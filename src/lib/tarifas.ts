...
import {
  TARIFA_INFO, numPeriodos, calcularCoste,
  type TarifaAcceso, type DatosSuministro, type DesglosePeriodo, type CosteCalculado,
} from './tarifas-base';

export type { TarifaAcceso, DatosSuministro, DesglosePeriodo, CosteCalculado };
export { TARIFA_INFO, numPeriodos, calcularCoste };
