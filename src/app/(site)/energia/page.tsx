...
/**
 * GESMECO ENERGÍA — la portada del área de energía.
 *
 * Es la home que había en la raíz, movida aquí tal cual. La raíz pasa a
 * presentar al grupo entero, porque son tres empresas y entrar por una de
 * ellas dejaba a las otras dos escondidas en un menú.
 *
 * No se ha tocado ni el contenido ni el orden: lo que funcionaba, funciona.
 */
export const metadata: Metadata = {
  title: "Gesmeco Energía | Tu asesor energético en Binéfar",
  description:
    "Análisis de facturas de luz y gas, auditorías energéticas y solar fotovoltaica en Binéfar y La Litera. Para hogares, granjas, comercios e industria.",
  alternates: { canonical: "/energia" },
};
